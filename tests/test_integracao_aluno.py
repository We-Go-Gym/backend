...
def test_update_aluno(client, aluno_cadastrado):
    ...
    response = client.patch(
        f"/Aluno/{aluno_id}",
        json={"nome_aluno": "Aluno Nome Atualizado"}
    )
...
@pytest.mark.parametrize(
    ...
    [
        ("nome_aluno", {
            # "nome_aluno": "Faltando",
            "email": "teste@email.com", "senha": "123", "idade": 20, 
            "peso_kg": 70, "altura": 1.70
        }),
        ("email", {
            "nome_aluno": "Aluno", 
        ...
        ("senha", {
            "nome_aluno": "Aluno", "email": "teste@email.com", 
            # "senha": "faltando", 
            "idade": 20, "peso_kg": 70, "altura": 1.70
        }),
    ]
)
