"""Módulo de teste para os endpoints de Treino"""
...
def test_update_treino(client, treino_cadastrado):
    ...
    response = client.put(f"/Treino/{treino_id}", json=json_completo)
...
def test_create_treino_erro_422_campos_faltantes(
    client, aluno_cadastrado, campo_faltante, json_payload
):
